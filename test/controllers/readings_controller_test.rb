...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { class: @reading.class, number: @reading.number, readings: @reading.readings, report_id: @reading.report_id } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { class: @reading.class, number: @reading.number, readings: @reading.readings, report_id: @reading.report_id } }
